...
class OnlineTest  extends JFrame implements ActionListener {
	...
	void set() {
    	...
    	if(current==0) {
    		...
    		radioButton[0].setText("Sream APi");
    		radioButton[1].setText("Serialization");
    		radioButton[2].setText("Splitertor");
    		radioButton[3].setText("Lamda Expression");

    				
    	}
    	if(current==1) {
    		label.setText("Que1: What is the purpose of BooleanSupplier function interface?");
    		radioButton[0].setText("represents supplier of Boolean-Valued results");
    		radioButton[1].setText("returns Boolean-Vlaued results");
    	...
    	if(current==2) {
    		label.setText("Que1: what is the return type of lamda expression?");
    	...
    	if(current==3) {
    		label.setText("Que1: which is the new method introduced in java 8 to itertate over a collection?");
    	...
    	if(current==4) {
    		label.setText("Que1: what is the substitute of rhino javascript engine in java8?");
    	...
    	if(current==5) {
    		label.setText("Que1: How to read entire file in one line using java8?");
    	...
    	if(current==6) {
    		label.setText("Que1:which feature of java7 allows to not explicitly close IO resource?");
    	...
    	if(current==7) {
    		label.setText("Que1:which of the following is not a core interface of Hibernate?");
    	...
    	if(current==8) {
    		label.setText("Que1: SessionFactory is a thread-safe object?");
    	...
    	if(current==9) {
    		label.setText("Que1:which of the following is not a state of object in Hibernate?");
    		radioButton[0].setText("Attaached");
